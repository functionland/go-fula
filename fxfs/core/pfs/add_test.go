...
func TestAddMultipleGCLive(t *testing.T) {
	...
	rfc := files.NewBytesFile([]byte(""))

	enc := NewEncodedFileFromNode(files.NewBytesFile([]byte("AtestfileAtestfileAtestfileAtestfileAtestfileAtestfileAtestfileAtestfileAtestfileAtestfileAtest")), []byte("jweeeeeeee"))
	...
	go func() {
		defer close(out)
		fn, err := adder.AddAllAndPin(context.Background(), slf)

		fmt.Println(fmt.Sprintf("Added Node %+v", fn), err)

		n, err := node.DAG.Get(context.Background(), fn.Cid())

		if err != nil {
			fmt.Println("ERRR", err)
		}

		fsn, err := unixfile.NewUnixfsFile(context.Background(), node.DAG, n)
		if err != nil {
			fmt.Println(err)
		}

		testu.PrintDag(n.(*merkledag.ProtoNode), node.DAG, 0)

		for _, lnk := range n.Links() {
			child, err := lnk.GetNode(context.Background(), node.DAG)
			if err != nil {
				panic(err)
			}

			fmt.Println(child)
			// fsn2, err := ft.FSNodeFromBytes(child.RawData())
			// if err != nil {
			// 	panic(err)
			// }
			// fmt.Printf("%+v", fsn2)
